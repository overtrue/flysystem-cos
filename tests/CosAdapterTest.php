...
namespace Overtrue\Flysystem\Cos\Tests;
...
class CosAdapterTest extends TestCase
{
    ...
    {
        $adapter = Mockery::mock(COSAdapter::class, ['secretID', 'secretKey', 'bucket', 'domain.com'])
            ->makePartial()
    ...
    {
        $this->assertSame([
            'contents' => \Overtrue\Flysystem\Cos\file_get_contents('http://domain.com/foo/file.md'),
            'path' => 'foo/file.md',
    ...
    public function testReadStream($adapter)
    {
        ...
        $this->assertSame([
            'stream' => \Overtrue\Flysystem\Cos\fopen('http://domain.com/foo/file.md', 'r'),
            'path' => 'foo/file.md',
    ...
    public function testSettersGetters()
    {
        ...
        $adapter = new COSAdapter('ak', 'sk', 'bucket', 'domain.com');
